...
import * as rtc_service_pb from './rtc_service_pb.js'; // proto import: "rtc_service.proto"
...
export class RtcClient {
  ...
  requestRtcStream(request: google_protobuf_empty_pb.Empty, metadata: grpcWeb.Metadata | null): Promise<rtc_service_pb.RtcId>;
  ...
  sendJsepMessage(request: rtc_service_pb.JsepMsg, metadata: grpcWeb.Metadata | null): Promise<google_protobuf_empty_pb.Empty>;
  ...
  receiveJsepMessages(request: rtc_service_pb.RtcId, metadata?: grpcWeb.Metadata): grpcWeb.ClientReadableStream<rtc_service_pb.JsepMsg> {
  ...
  receiveJsepMessage(request: rtc_service_pb.RtcId, metadata: grpcWeb.Metadata | null): Promise<rtc_service_pb.JsepMsg>;
