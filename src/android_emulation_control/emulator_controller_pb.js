    ...
    var f,
      obj = {
        ...
        entriesList: jspb.Message.toObjectList(
          msg.getEntriesList(),
          proto.android.emulation.control.LogcatEntry.toObject,
          includeInstance
        ),
      };
...
proto.android.emulation.control.LogMessage.prototype.getSort = function () {
  return /** @type {!proto.android.emulation.control.LogMessage.LogType} */ (jspb.Message.getFieldWithDefault(
    this,
    4,
    0
  ));
...
proto.android.emulation.control.LogcatEntry.prototype.getLevel = function () {
  return /** @type {!proto.android.emulation.control.LogcatEntry.LogLevel} */ (jspb.Message.getFieldWithDefault(
    this,
    4,
    0
  ));
...
proto.android.emulation.control.VmConfiguration.prototype.getHypervisortype = function () {
  return /** @type {!proto.android.emulation.control.VmConfiguration.VmHypervisorType} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.android.emulation.control.TouchEvent.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        touchesList: jspb.Message.toObjectList(
          msg.getTouchesList(),
          proto.android.emulation.control.Touch.toObject,
          includeInstance
        ),
...
proto.android.emulation.control.KeyboardEvent.prototype.getCodetype = function () {
  return /** @type {!proto.android.emulation.control.KeyboardEvent.KeyCodeType} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
...
proto.android.emulation.control.KeyboardEvent.prototype.getEventtype = function () {
  return /** @type {!proto.android.emulation.control.KeyboardEvent.KeyEventType} */ (jspb.Message.getFieldWithDefault(
    this,
    2,
    0
  ));
...
proto.android.emulation.control.BatteryState.prototype.getCharger = function () {
  return /** @type {!proto.android.emulation.control.BatteryState.BatteryCharger} */ (jspb.Message.getFieldWithDefault(
    this,
    3,
    0
  ));
...
proto.android.emulation.control.BatteryState.prototype.getHealth = function () {
  return /** @type {!proto.android.emulation.control.BatteryState.BatteryHealth} */ (jspb.Message.getFieldWithDefault(
    this,
    5,
    0
  ));
...
proto.android.emulation.control.BatteryState.prototype.getStatus = function () {
  return /** @type {!proto.android.emulation.control.BatteryState.BatteryStatus} */ (jspb.Message.getFieldWithDefault(
    this,
    6,
    0
  ));
...
proto.android.emulation.control.ImageStream.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getFormat();
  if (f != null) {
    writer.writeMessage(2, f, proto.android.emulation.control.ImageFormat.serializeBinaryToWriter);
  }
};
...
proto.android.emulation.control.ImageFormat.prototype.getFormat = function () {
  return /** @type {!proto.android.emulation.control.ImageFormat.ImgFormat} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
...
proto.android.emulation.control.Rotation.prototype.getRotation = function () {
  return /** @type {!proto.android.emulation.control.Rotation.SkinRotation} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
...
proto.android.emulation.control.TelephoneOperation.prototype.getOperation = function () {
  return /** @type {!proto.android.emulation.control.TelephoneOperation.Operation} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
...
proto.android.emulation.control.TelephoneResponse.prototype.getResponse = function () {
  return /** @type {!proto.android.emulation.control.TelephoneResponse.Response} */ (jspb.Message.getFieldWithDefault(
    this,
    1,
    0
  ));
    ...
    var f,
      obj = {
        entryList: jspb.Message.toObjectList(
          msg.getEntryList(),
          proto.android.emulation.control.Entry.toObject,
          includeInstance
        ),
      };
  ...
  proto.android.emulation.control.EmulatorStatus.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        vmconfig:
          (f = msg.getVmconfig()) && proto.android.emulation.control.VmConfiguration.toObject(includeInstance, f),
        hardwareconfig:
          (f = msg.getHardwareconfig()) && proto.android.emulation.control.EntryList.toObject(includeInstance, f),
      };
