...
proto.waterfall.Cmd.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pipein: jspb.Message.getFieldWithDefault(msg, 4, false),
...
proto.waterfall.CmdProgress.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.waterfall.Cmd.serializeBinaryToWriter
    );
  }
...
proto.waterfall.CmdProgress.prototype.getCmd = function() {
  return /** @type{?proto.waterfall.Cmd} */ (
    jspb.Message.getWrapperField(this, proto.waterfall.Cmd, 5));
};
...
proto.waterfall.ForwardMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    payload: msg.getPayload_asB64(),
    rebind: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
...
proto.waterfall.PortForwardRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    rebind: jspb.Message.getFieldWithDefault(msg, 3, false),
...
proto.waterfall.PortForwardRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.waterfall.ForwardSession.serializeBinaryToWriter
    );
  }
};
...
proto.waterfall.PortForwardRequest.prototype.getSession = function() {
  return /** @type{?proto.waterfall.ForwardSession} */ (
    jspb.Message.getWrapperField(this, proto.waterfall.ForwardSession, 4));
};
...
proto.waterfall.ForwardedSessions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.waterfall.ForwardSession.toObject, includeInstance)
  };
