...
var _IceServer = require("./service/IceServer");
  ...
  (0, _createClass2["default"])(StreamingView, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props = this.props,
          ...
          measurementScheduler = _this$props.measurementScheduler;
      ...
      var readyWasTriggered = false;

      var handleEmulatorReady = function handleEmulatorReady(onUserInteractionCallback) {
        var _context2;

        console.info((0, _concat["default"])(_context2 = "Ready was triggered for instance ".concat(_this2.instanceID, ". ")).call(_context2, readyWasTriggered ? 'Second trigger' : 'First trigger'));
      ...
      }).on(_StreamingEvent["default"].STREAM_WEBRTC_READY, function (onUserInteractionCallback) {
        console.info(_StreamingEvent["default"].STREAM_WEBRTC_READY);
        handleEmulatorReady(onUserInteractionCallback);
      }).on(_StreamingEvent["default"].STREAM_EMULATOR_READY, function (onUserInteractionCallback) {
        console.info(_StreamingEvent["default"].STREAM_EMULATOR_READY);
        handleEmulatorReady(onUserInteractionCallback);
      });
      ...
      (0, _StreamingController["default"])({
        ...
        return (0, _IceServer.requestIceServers)(apiEndpoint, edgeNodeId).then(function (iceServers) {
          return [streamEndpoint, iceServers];
        });
      }).then(function (_ref) {
        var _ref2 = (0, _slicedToArray2["default"])(_ref, 2),
            streamEndpoint = _ref2[0],
            iceServers = _ref2[1];

        if (_this2.measurement) {
          _this2.measurement.initWebRtc("".concat((0, _urlParse["default"])(streamEndpoint).origin, "/measurement/webrtc"), pingInterval, iceServers);
        }
        ...
        _StreamingEvent["default"].edgeNode(edgeNodeId).on(_StreamingEvent["default"].STREAM_EMULATOR_READY, measurementScheduler.stopMeasuring);

        _StreamingEvent["default"].edgeNode(edgeNodeId).on(_StreamingEvent["default"].STREAM_TERMINATED, measurementScheduler.startMeasuring);
    ...
    value: function componentWillUnmount() {
      ...
      _StreamingEvent["default"].edgeNode(this.props.edgeNodeId).removeListener(_StreamingEvent["default"].STREAM_EMULATOR_READY, this.props.measurementScheduler.stopMeasuring);

      _StreamingEvent["default"].edgeNode(this.props.edgeNodeId).removeListener(_StreamingEvent["default"].STREAM_TERMINATED, this.props.measurementScheduler.startMeasuring);
    }
    /**
    ...
    value: function registerUserEventsHandler() {
      ...
      _StreamingEvent["default"].edgeNode(this.props.edgeNodeId).once(_StreamingEvent["default"].STREAM_READY, function () {
        ...
        if (_this4.props.userClickedPlayAt > 0) {
          ...
          var streamLoadingTime = (0, _now["default"])() - _this4.props.userClickedPlayAt;
        ...
        _StreamingEvent["default"].edgeNode(_this4.props.edgeNodeId).on(_StreamingEvent["default"].STREAM_AUDIO_CODEC, function (codec) {
          ...
          _StreamingEvent["default"].edgeNode(_this4.props.edgeNodeId).emit(_StreamingEvent["default"].USER_EVENT_REPORT, {
            ...
            value: codec,
            message: (0, _concat["default"])(_context6 = "User event - ".concat(_StreamingEvent["default"].STREAM_AUDIO_CODEC, ": ")).call(_context6, codec)
          });
        });
        ...
        _StreamingEvent["default"].edgeNode(_this4.props.edgeNodeId).on(_StreamingEvent["default"].STREAM_VIDEO_CODEC, function (codec) {
          ...
          _StreamingEvent["default"].edgeNode(_this4.props.edgeNodeId).emit(_StreamingEvent["default"].USER_EVENT_REPORT, {
            ...
            value: codec,
            message: (0, _concat["default"])(_context7 = "User event - ".concat(_StreamingEvent["default"].STREAM_VIDEO_CODEC, ": ")).call(_context7, codec, ".")
          });
        });
      });
    }
    ...
    function get() {
      return {
        ...
        measurementScheduler: _propTypes["default"].object.isRequired,
