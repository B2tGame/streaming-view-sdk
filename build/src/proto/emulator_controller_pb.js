...
proto.android.emulation.control.VmRunState.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.VmRunState.RunState} */
        reader.readEnum();
        msg.setState(value);
        break;
...
proto.android.emulation.control.PhysicalModelValue.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.PhysicalModelValue.PhysicalType} */
        reader.readEnum();
        msg.setTarget(value);
        break;
      ...
      case 2:
        var value =
        /** @type {!proto.android.emulation.control.PhysicalModelValue.State} */
        reader.readEnum();
        msg.setStatus(value);
        break;
...
proto.android.emulation.control.PhysicalModelValue.prototype.getValue = function () {
  return (
    /** @type{?proto.android.emulation.control.ParameterValue} */
...
proto.android.emulation.control.SensorValue.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.SensorValue.SensorType} */
        reader.readEnum();
        msg.setTarget(value);
        break;
      ...
      case 2:
        var value =
        /** @type {!proto.android.emulation.control.SensorValue.State} */
        reader.readEnum();
        msg.setStatus(value);
        break;
...
proto.android.emulation.control.LogMessage.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 4:
        var value =
        /** @type {!proto.android.emulation.control.LogMessage.LogType} */
        reader.readEnum();
        msg.setSort(value);
        break;
...
proto.android.emulation.control.LogMessage.prototype.getEntriesList = function () {
  return (
    /** @type{!Array<!proto.android.emulation.control.LogcatEntry>} */
...
proto.android.emulation.control.LogcatEntry.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 4:
        var value =
        /** @type {!proto.android.emulation.control.LogcatEntry.LogLevel} */
        reader.readEnum();
        msg.setLevel(value);
        break;
...
proto.android.emulation.control.VmConfiguration.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.VmConfiguration.VmHypervisorType} */
        reader.readEnum();
...
proto.android.emulation.control.TouchEvent.prototype.getTouchesList = function () {
  return (
    /** @type{!Array<!proto.android.emulation.control.Touch>} */
...
proto.android.emulation.control.KeyboardEvent.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.KeyboardEvent.KeyCodeType} */
        reader.readEnum();
      ...
      case 2:
        var value =
        /** @type {!proto.android.emulation.control.KeyboardEvent.KeyEventType} */
        reader.readEnum();
...
proto.android.emulation.control.BatteryState.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        var value =
        /** @type {!proto.android.emulation.control.BatteryState.BatteryCharger} */
        reader.readEnum();
      ...
      case 5:
        var value =
        /** @type {!proto.android.emulation.control.BatteryState.BatteryHealth} */
        reader.readEnum();
        msg.setHealth(value);
        break;
      ...
      case 6:
        var value =
        /** @type {!proto.android.emulation.control.BatteryState.BatteryStatus} */
        reader.readEnum();
        msg.setStatus(value);
        break;
...
proto.android.emulation.control.ImageFormat.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.ImageFormat.ImgFormat} */
        reader.readEnum();
        msg.setFormat(value);
        break;
...
proto.android.emulation.control.ImageFormat.prototype.getRotation = function () {
  return (
    /** @type{?proto.android.emulation.control.Rotation} */
...
proto.android.emulation.control.Image.prototype.getFormat = function () {
  return (
    /** @type{?proto.android.emulation.control.ImageFormat} */
...
proto.android.emulation.control.Rotation.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.Rotation.SkinRotation} */
        reader.readEnum();
        msg.setRotation(value);
        break;
...
proto.android.emulation.control.PhoneCall.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.PhoneCall.Operation} */
        reader.readEnum();
...
proto.android.emulation.control.PhoneResponse.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value =
        /** @type {!proto.android.emulation.control.PhoneResponse.Response} */
        reader.readEnum();
...
proto.android.emulation.control.EntryList.prototype.getEntryList = function () {
  return (
    /** @type{!Array<!proto.android.emulation.control.Entry>} */
...
proto.android.emulation.control.EmulatorStatus.prototype.getVmconfig = function () {
  return (
    /** @type{?proto.android.emulation.control.VmConfiguration} */
...
proto.android.emulation.control.EmulatorStatus.prototype.getHardwareconfig = function () {
  return (
    /** @type{?proto.android.emulation.control.EntryList} */
...
proto.android.emulation.control.EmulatorStatus.prototype.clearHardwareconfig = function () {
  this.setHardwareconfig(undefined);
};
/**
 * Returns whether this field is set.
 * @return {!boolean}
...
proto.android.emulation.control.AudioFormat.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        var value =
        /** @type {!proto.android.emulation.control.AudioFormat.Channels} */
        reader.readEnum();
      ...
      case 3:
        var value =
        /** @type {!proto.android.emulation.control.AudioFormat.SampleFormat} */
        reader.readEnum();
        msg.setFormat(value);
        break;
...
proto.android.emulation.control.AudioPacket.prototype.getFormat = function () {
  return (
    /** @type{?proto.android.emulation.control.AudioFormat} */
...
proto.android.emulation.control.AudioPacket.prototype.getAudio_asB64 = function () {
  return (
    /** @type {string} */
    jspb.Message.bytesAsB64(this.getAudio())
  );
};
/**
 * optional bytes audio = 3;
...
proto.android.emulation.control.AudioPacket.prototype.getAudio_asU8 = function () {
  return (
    /** @type {!Uint8Array} */
    jspb.Message.bytesAsU8(this.getAudio())
  );
};
/** @param {!(string|Uint8Array)} value */
